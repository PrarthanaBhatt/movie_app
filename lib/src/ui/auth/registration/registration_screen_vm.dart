...
class RegistrationScreenVm extends BaseViewModel {
  ...
  void validateRegistration(
    ...
    print(
        "Registration Values ==> \n Name : $regNameController , Email : $regEmailController, DOB: $regDobController, Gender : $gender, stateValue: $stateValue, MbNumber : $regMobileNumberController, Password : $regPasswordController ");
